    ...
    return (
        <div className="flex flex-col h-full px-12 py-10 items-center justify-center">
            <div className="card p-10 max-w-md text-center flex flex-col items-center gap-4">
                <AlertCircle className="w-10 h-10 text-[var(--dtn-muted)]" />
                <div>
                    <p className="text-lg font-semibold text-[var(--dtn-navy)] mb-1">
                    ...
                    {slide.title && (
                        <p className="text-xs text-[var(--dtn-muted)] mt-2 opacity-60">Slide title: {slide.title}</p>
                    )}
                </div>
            </div>
        </div>
